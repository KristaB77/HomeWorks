...
*/
var daysPassed: Float = 42 * 365.25
/*
Exercise 2.5
...
var ac = 8.0
var cb = 6.0
var ab = sqrt(pow(ac,2)+pow(cb,2))
var perimeter = ac + cb + ab
/*
Heron's Formula
*/
var s = perimeter/2
var area = sqrt(s*(s-ac)*(s-cb)*(s*ab))
print("Triangle stats : AC = \(ac), CB = \(cb), Hypotenuse AB = \(ab), Area = \(area), Perimeter = \(perimeter).")
